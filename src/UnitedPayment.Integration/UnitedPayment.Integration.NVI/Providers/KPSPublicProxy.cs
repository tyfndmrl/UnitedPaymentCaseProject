namespace MernisServiceReference
{
    ...
    public partial class KPSPublicSoapClient : System.ServiceModel.ClientBase<MernisServiceReference.KPSPublicSoap>, MernisServiceReference.KPSPublicSoap
    {
        ...
        public KPSPublicSoapClient() :
                base(KPSPublicSoapClient.GetBindingForEndpoint(EndpointConfiguration.KPSPublicSoap), KPSPublicSoapClient.GetEndpointAddress(EndpointConfiguration.KPSPublicSoap))
        {
            this.Endpoint.Name = EndpointConfiguration.KPSPublicSoap.ToString();
